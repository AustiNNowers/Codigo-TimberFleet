...
{
    public static class TFormulario
    {
        ...
        private static void PlanificarObjeto(JsonElement obj, Dictionary<string, string> plano)
        {
            ...
            foreach (var p in obj.EnumerateObject())
            {
                ...
                if (p.Value.ValueKind == JsonValueKind.Object) PlanificarObjeto(p.Value, plano);

                if (p.Value.ValueKind == JsonValueKind.Array)
                {
                    foreach (var elemento in p.Value.EnumerateArray()) PlanificarObjeto(elemento, plano);
                }
            }
